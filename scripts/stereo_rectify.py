...
def calibrate():
    ...
    path = "./images/"
    left = "img814_left.jpg"
    right = "img814_right.jpg"
    ...
    if cv2.waitKey(0)==27:
        left_save = os.path.join(path, "img814_left.jpg") 
        right_save = os.path.join(path, "img814_right.jpg") 
        cv2.imwrite(left_save, left_dst)
        cv2.imwrite(right_save, right_dst)
